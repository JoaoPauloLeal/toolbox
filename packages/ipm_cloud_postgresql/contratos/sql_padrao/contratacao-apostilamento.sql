...
from (
	select
		...
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-apostilamento', c.clicodigo, c.ctranosup, c.ctridentsup, '@', c.ctrano, c.ctrnro))) as id_gerado
