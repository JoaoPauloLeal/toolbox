select
	...
	(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-item', tab.clicodigo, tab.minano, tab.nro_contrato, '@', tab.cmiid))) as id_contratacao_item,
	58285 as id_aditivo,
	*,
	'@' as separador,
