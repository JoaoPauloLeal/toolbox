select
	...
	*,
	(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat('305', 'solicitacao-item', chave_dsk1, chave_dsk2, chave_dsk3, chave_dsk4, chave_dsk5))) as id_gerado
from (
	select
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat('305', 'entidade', clicodigo)))::text as chave_dsk1,
		...
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat('305', 'solicitacao', (select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat('305', 'entidade', clicodigo))), rqcano, rqcnro))) as id_solicitacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material', prdcodigo))) as id_material,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-especificacao', prdcodigo))) as id_especificacao,
...
where (select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat('305', 'solicitacao-item', chave_dsk1, chave_dsk2, chave_dsk3, chave_dsk4, chave_dsk5))) is null
