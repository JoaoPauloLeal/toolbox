insert into public.controle_migracao_registro_compras(sistema, tipo_registro, descricao_tipo_registro, id_gerado, i_chave_dsk1, hash_chave_dsk) values
...
from (
	...
	tfscodigo,
	   (case tfscodigo
		...
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305,'tipo-responsavel-contrato', tfscodigo))) as id_gerado
