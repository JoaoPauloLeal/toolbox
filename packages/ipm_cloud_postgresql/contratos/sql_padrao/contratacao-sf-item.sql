...
from (
	(select
		...
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao', coalesce(ct.clicodigoctl, ct.clicodigo), ct.ctrano, ct.ctridentificador))) as id_contratacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf', c.clicodigo, ct.ctrano, ct.ctridentificador, '@', c.copano, c.copnro))) as id_solicitacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-item', coalesce(ct.clicodigoctl, ct.clicodigo), ct.ctrano, ct.ctridentificador, '@', ic.cmiid))) as id_contratacao_item,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material', ic.prdcodigo))) as id_material,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-especificacao', ic.prdcodigo))) as id_especificacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-duplicado-especificacao', ic.clicodigo, ic.minano, ic.minnro, '@', ic.cmiid))) as id_material_duplicado_espec,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf-item', c.clicodigo, ct.ctrano, ct.ctridentificador, '@', c.copano, c.copnro, '@', ic.cmiid))) as id_gerado
	from wco.tbcompra c
...
union all
	(select
		...
		(ic.itcqtde - coalesce((select sum(e.iesqtde) from wco.tbitemcompraest e where e.clicodigo = ic.clicodigo and e.copano = ic.copano and e.copnro = ic.copnro and e.itcitem = ic.itcitem), 0)) as qtd_liquida,
		(ic.itcvlrtotal - coalesce((select sum(e.iesvlrtotal) from wco.tbitemcompraest e where e.clicodigo = ic.clicodigo and e.copano = ic.copano and e.copnro = ic.copnro and e.itcitem = ic.itcitem), 0)) as valor_liquido,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao', coalesce(ct.clicodigoctl, c.clicodigo), ct.ctranosup, ct.ctridentsup))) as id_contratacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf', c.clicodigo, c.ctrano, c.ctridentificador, '@', c.copano, c.copnro))) as id_solicitacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-item', coalesce(ct.clicodigoctl, c.clicodigo), ct.ctranosup , ct.ctridentsup, '@', ic.cmiid))) as id_contratacao_item,
		--2802275 as id_contratacao_item,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material', ic.prdcodigo))) as id_material,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-especificacao', ic.prdcodigo))) as id_especificacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-duplicado-especificacao', ic.clicodigo, ic.minano, ic.minnro, '@', ic.cmiid))) as id_material_duplicado_espec,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf-item', ct.clicodigo, ct.ctrano, ct.ctridentificador, '@', c.copano, c.copnro, '@', ic.cmiid))) as id_gerado
	from wco.tbcompra c
...
union all
	(select
		...
		(ic.itcqtde - coalesce((select sum(e.iesqtde) from wco.tbitemcompraest e where e.clicodigo = ic.clicodigo and e.copano = ic.copano and e.copnro = ic.copnro and e.itcitem = ic.itcitem), 0)) as qtd_liquida,
		(ic.itcvlrtotal - coalesce((select sum(e.iesvlrtotal) from wco.tbitemcompraest e where e.clicodigo = ic.clicodigo and e.copano = ic.copano and e.copnro = ic.copnro and e.itcitem = ic.itcitem), 0)) as valor_liquido,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao', ct.clicodigo, ct.ctrano, ct.ctridentificador))) as id_contratacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf', c.clicodigo, ct.ctrano, ct.ctridentificador, '@', c.copano, c.copnro))) as id_solicitacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-item', ct.clicodigo, ct.ctrano , ct.ctridentificador, '@', ic.cmiid))) as id_contratacao_item,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material', ic.prdcodigo))) as id_material,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-especificacao', ic.prdcodigo))) as id_especificacao,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'material-duplicado-especificacao', ic.clicodigo, ic.minano, ic.minnro, '@', ic.cmiid))) as id_material_duplicado_espec,
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'contratacao-sf-item', ct.clicodigo, ct.ctrano, ct.ctridentificador, '@', c.copano, c.copnro, '@', ic.cmiid))) as id_gerado
