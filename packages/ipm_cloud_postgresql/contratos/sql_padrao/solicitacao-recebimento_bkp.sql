...
from (
	(select distinct
		...
		(select id_gerado from public.controle_migracao_registro_compras where hash_chave_dsk = md5(concat(305, 'solicitacao-recebimento', nf.clicodigo, nf.copano, nf.copnro, '@', nf.nfisequencia))) as id_gerado
