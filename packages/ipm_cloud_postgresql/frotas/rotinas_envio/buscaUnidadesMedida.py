...
tipo_registro = 'unidades-medida'
sistema = 306
limite_lote = 100
url = "https://frotas.betha.cloud/frotas-services/api/unidades-medida"
...
def iniciar_processo_busca(params_exec, ano, *args, **kwargs):
    ...
    for item in req_res:
        idGerado = item['id']
        chave_dsk1 = item['simbolo'].upper()
        chave_dsk2 = item['nome'].upper()
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Busca de Unidades de Medida',
            'id_gerado': idGerado,
