...
--
--  1 - CRIA TABELA controle_migracao_auxiliar
--
CREATE TABLE public.controle_migracao_auxiliar
(
    sistema integer NOT NULL,
    tipo_registro text NOT NULL,
    hash_chave_dsk text NOT NULL UNIQUE,
...
ALTER TABLE public.controle_migracao_auxiliar
    OWNER to postgres;
%/%


-- criar função para buscar o código ibge
--

CREATE OR REPLACE FUNCTION bth_get_codigo_ibge
(
	arg_1 text
)
RETURNS integer LANGUAGE plpgsql AS $$
DECLARE
	ret_cod_ibge integer;
BEGIN
