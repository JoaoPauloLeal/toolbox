  ...
  from (
		SELECT t.pronumero as key1,
		  ...
		  FROM wpt.tbprocesso t join wpt.tbhistoricoprocesso t2 on t.procodigo = t2.procodigo and t.hissequencia = t2.hissequencia
		  						...
		  						join wpt.tbarquivamento t4 on t.procodigo = t4.procodigo
		 ...
		 WHERE proano = ano_extracao
		   ...
		   and public.bth_get_situacao_registro('304', 'arquivamentos', cast(t.pronumero as varchar), cast(t.procodigo as varchar), cast(t.proano as varchar)) in (0)
	) as tabAux
