select * from sapo.desmembramento_arrecad da where i_entidades = {{entidade}} and portaria_rubr = {{exercicio}} and i_rubricas_auxiliar in (select masc from (
SELECT bethadba.rec_loa.i_exercicios,   
         ...
         bethadba.contas.mascara as masc,   
...
ORDER BY bethadba.rec_loa.i_entidades ASC,   
         ...
         bethadba.rec_loa.i_rec_loa ASC) as tb)