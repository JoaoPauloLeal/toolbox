  SELECT bethadba.rec_loa.i_exercicios,
         ...
         else 'Rubrica n�o cadastrada para o exerc�cio corrente! (efetuar o cadastro para regularizar)' endif as contas_prop_descricao,
   ...
   WHERE ( bethadba.contas.i_planos_contas = bethadba.rec_loa.i_planos_contas ) AND
         ...
         and bethadba.contas.mascara like '9'+'{{mascara}}%'
         and bethadba.rec_loa.i_exercicios = {{ano}}
