...
def coletar_dados(params_exec):
    ...
    try:
        ...
        conn = db.conectar()
        df = db.consulta_sql(query, conn, index_col='id')
...
def iniciar_envio(params_exec, dados_assunto):
    ...
    for i in dict_dados:
        ...
        if not db.checa_existe_registro(tipo_registro, str(i['i_matricula_cei'])):
            id_registro, mensagem_erro = cloud.envia_registro(url, json_envio)
