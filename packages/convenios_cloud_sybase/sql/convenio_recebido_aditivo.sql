select
	...
	(select i_chave_dsk6 from bethadba.controle_migracao_registro where tipo_registro = 'convenio_recebido' and i_chave_dsk1 = {{id_entidade}}
	and i_chave_dsk2 like isnull(tab.convenio_superior,'')) as data_assinatura_convenio_superior,
	(select i_chave_dsk5 from bethadba.controle_migracao_registro where tipo_registro = 'convenio_recebido' and i_chave_dsk1 = {{id_entidade}}
