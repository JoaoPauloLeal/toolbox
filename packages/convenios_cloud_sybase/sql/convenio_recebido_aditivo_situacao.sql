select
	...
	(select first id_gerado from bethadba.controle_migracao_registro where tipo_registro = 'convenio_recebido_aditivo' and i_chave_dsk1 = {{id_entidade}}
	and i_chave_dsk2 like isnull(tab.i_convenio,'')) as id_gerado_convenio_aditivo,
...
from
	...
	'convenio_recebido_aditivo_situacao',
	{{id_entidade}},
	id_gerado_convenio,
	id_gerado_tipo,
	tab.data_situacao
